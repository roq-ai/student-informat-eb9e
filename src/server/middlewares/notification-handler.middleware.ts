...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'student.update': {
    roles: ['system-administrator', 'registrar', 'faculty-member'],
    key: 'student-admission-update',
    tenantPath: ['university', 'term', 'student'],
    userPath: [],
  },
  'course.update': {
    roles: ['system-administrator', 'admissions-officer', 'faculty-member'],
    key: 'course-registration-update',
    tenantPath: ['university', 'term', 'course'],
    userPath: [],
  },
  'term.update': {
    roles: ['system-administrator', 'admissions-officer', 'faculty-member'],
    key: 'term-activation',
    tenantPath: ['university', 'term'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['system-administrator', 'admissions-officer', 'registrar', 'faculty-member'];
