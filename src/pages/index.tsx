  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Empowering Education with Student Information System: Streamlining Admissions, Course Registration, Term Activation, Course Scheduling, and Time Table Management."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Empowering Education with Student Information System: Streamlining Admissions, Course Registration, Term Activation, Course Scheduling, and Time Table Management.`}
            </Text>
            <Box
