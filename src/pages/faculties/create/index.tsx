...
import { createFaculty } from 'apiSdk/faculties';
...
function FacultyCreatePage() {
  const router = useRouter();
  const [error, setError] = useState(null);

  const handleSubmit = async (values: FacultyInterface, { resetForm }: FormikHelpers<any>) => {
    setError(null);
    try {
  ...
  const formik = useFormik<FacultyInterface>({
    initialValues: {
      name: '',
      department: '',
      designation: '',
