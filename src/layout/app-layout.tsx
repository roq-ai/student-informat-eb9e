...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['system-administrator', 'admissions-officer', 'registrar', 'faculty-member'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Faculties', path: '/faculties', entity: 'faculty', service: AccessServiceEnum.PROJECT, icon: FiUsers },
    { name: 'Students', path: '/students', entity: 'student', service: AccessServiceEnum.PROJECT, icon: FiUserCheck },
    { name: 'Terms', path: '/terms', entity: 'term', service: AccessServiceEnum.PROJECT, icon: FiCalendar },
